...
public class TradableUserData {
    ...
    /**
     * The String username of the user whose order or quote-side. Cannot be null
     * or empty.
     */
    protected String userName;

    /**
     * The string stock symbol that the order or quote-side was submitted for
     * Cannot be null or empty.
     */
    protected String stockSymbol;

    /**
     * The side (BUY/SELL) of the order or quote-side. Must be a valid side.
     */
    protected BookSide side;

    /**
     * The String identifier of the order or quote-side. Cannot be null.
     */
    public String id;
     ...
     *
     * @param username The String username of the user whose order or
     * quote-side.
     * @throws DataValidationException if username passed in is null or empty
     */
     ...
     *
     * @param product The string stock symbol that the order or quote-side was
     * submitted for (â€œIBMâ€�, â€œGEâ€�, etc.).
     * @throws DataValidationException If the product passed in is null or empty
     */
     ...
     *
     * @param side The side (BUY/SELL) of the order or quote-side.
     */
     ...
     * Set the id
     *
     * @param id The String identifier of the order or quote-side.
     * @throws DataValidationException If the id passed in is null
     */
