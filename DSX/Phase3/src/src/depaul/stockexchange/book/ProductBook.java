...
/**
 * A ProductBook object maintains the Buy and Sell sides of a stockâ€™s â€œbookâ€�.
 * 
 * the list of not-yet-traded (i.e., â€œbookedâ€�) Orders and 
 ...
 * â€“ one for the BUY side and one for the SELL side.
 * 
 * @author jimliu
 */
public class ProductBook {
    ...
    /**
     * A list of â€œoldâ€� Tradables (those that have been completely traded or 
    ...
    /**
     * This method will â€œOpenâ€� the book for trading. 
     */
    ...
    /**
     * This method will â€œCloseâ€� the book for trading. 
     */
    ...
    /**
     * This method will cancel the specified userâ€™s Quote 
    ...
    /**
     * This method should add the provided Quoteâ€™s sides to 
     * the Buy and Sell ProductSideBooks.
     * @param q 
     */
    public synchronized void addToBook(Quote q) 
            throws DataValidationException, DataValidationException, NotSubscribedException {
        if (q == null) {
    ...
    /**
     * This method needs to determine if the â€œmarketâ€� for this stock product 
