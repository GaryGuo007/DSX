 ...
 * individually, this DTO will be used to facilitate the data transfer. This
 * class will work with the publishers so it should be put into a package (i.e.,
 * "publishers") that you will soon add the publishers to.
 * 
 * @author Xin Guo
	...
	public String toString() {
		return String
				.format(getClass().getName()
						+ "Product: %s, buyPrice: %s, buyVolume: %s, sellPrice: %s, sellVolume: %s ",
