...
public interface Tradable {
	 ...
	 */
	void setCancelledVolume(int newCancelledVolume) throws DataValidationException;
	 ...
	 */
	void setRemainingVolume(int newRemainingVolume) throws DataValidationException;
